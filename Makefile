...
#    Updated: 2024/02/20 23:31:57 by tunsal           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
UTILS_SRCS		= $(UTILS_DIR)exit_error.c $(UTILS_DIR)exit_error_mlx.c $(UTILS_DIR)print_usage.c $(UTILS_DIR)parse_args.c $(UTILS_DIR)parse_double.c $(UTILS_DIR)ft_split_e.c $(UTILS_DIR)map.c $(UTILS_DIR)color.c $(UTILS_DIR)handler_mouse.c $(UTILS_DIR)handler_keyboard.c
